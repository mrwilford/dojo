...
export class List{
   ...
   * @return {List} The sublist at the index position.
   * @example ```
   ...
   * @return {Array} Array of elements that were removed.
   * @example ```
...
export class ListStack extends List{
   ...
   * @return {ListStack} This ListStack.
   * @example ```
   ...
   * @return {Array} Array of elements that were popped off.
   * @example ```
...
export class ListQueue extends List{
   ...
   * @return {ListQueue} This ListQueue.
   * @example ```
   ...
   * @return {Array} Array of elements that were dequeued.
   * @example ```
